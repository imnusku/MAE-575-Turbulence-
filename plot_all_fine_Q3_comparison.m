%% Code to plot all fine meshes

fineke=xlsread('fineke.csv');
finekw=xlsread("finekw.csv");
finerstm=xlsread("finerstm.csv");
%% Fine ke
H=0.0127;
xc=(fineke(:,2)/H)-15;
yc=(fineke(:,3)/H);
...
um=finekw(:,7)/44.2;
vm=finekw(:,8)/44.2;
km=finekw(:,9)/(44.2*44.2);
em=(finekw(:,10)*H)/(44.2*44.2*44.2);
uum=(finekw(:,4)*1000)/(44.2*44.2);
vvm=(finekw(:,5)*1000)/(44.2*44.2);
uvm=(finekw(:,6)*1000)/(44.2*44.2);
...
uf=finerstm(:,4)/44.2;
vf=finerstm(:,5)/44.2;
kf=finerstm(:,6)/(44.2*44.2);
ef=(finerstm(:,10)*H)/(44.2*44.2*44.2);
uuf=(finerstm(:,7)*1000)/(44.2*44.2);
vvf=(finerstm(:,8)*1000)/(44.2*44.2);
uvf=(finerstm(:,9)*1000)/(44.2*44.2);
%% Plots for u


[idxc1,idxc4,idxc6,idxc10]=index(xc,yc);
[idxm1,idxm4,idxm6,idxm10]=index(xm,ym);
[idxf1,idxf4,idxf6,idxf10]=index(xf,yf);

figure(1)
plot(uc(idxc1),yc(idxc1),'r',um(idxm1),ym(idxm1),'b',uf(idxf1),yf(idxf1),'g',xh1(:,2),xh1(:,1),'k-d')
...
set(y2,'Fontsize',12)
l2=legend('$k-\epsilon$ Model Using Fine Mesh','$k-\omega$ Model Using Fine Mesh', ...
    'RSTM Model Using Fine Mesh','Driver and Seegmiller Data','Location','northwest');
set(l2,'Interpreter','latex')
set(l2,'Fontsize',9)


figure(2)
plot(uc(idxc4),yc(idxc4),'r',um(idxm4),ym(idxm4),'b',uf(idxf4),yf(idxf4),'g',xh4(:,2),xh4(:,1),'k-d')
...
figure(3)
plot(uc(idxc6),yc(idxc6),'r',um(idxm6),ym(idxm6),'b',uf(idxf6),yf(idxf6),'g',xh6(:,2),xh6(:,1),'k-d')
...
figure(4)
plot(uc(idxc10),yc(idxc10),'r',um(idxm10),ym(idxm10),'b',uf(idxf10),yf(idxf10),'g',xh10(:,2),xh10(:,1),'k-d')
...
figure(5)
plot(vc(idxc1),yc(idxc1),'r',vm(idxm1),ym(idxm1),'b',vf(idxf1),yf(idxf1),'g',xh1(:,3),xh1(:,1),'k-d')
...
set(y2,'Fontsize',12)
l2=legend('$k-\epsilon$ Model Using Fine Mesh','$k-\omega$ Model Using Fine Mesh', ...
    'RSTM Model Using Fine Mesh','Driver and Seegmiller Data','Location','northeast');
set(l2,'Interpreter','latex')
set(l2,'Fontsize',9)


figure(6)
plot(vc(idxc4),yc(idxc4),'r',vm(idxm4),ym(idxm4),'b',vf(idxf4),yf(idxf4),'g',xh4(:,3),xh4(:,1),'k-d')
...
figure(7)
plot(vc(idxc6),yc(idxc6),'r',vm(idxm6),ym(idxm6),'b',vf(idxf6),yf(idxf6),'g',xh6(:,3),xh6(:,1),'k-d')
...
figure(8)
plot(vc(idxc10),yc(idxc10),'r',vm(idxm10),ym(idxm10),'b',vf(idxf10),yf(idxf10),'g',xh10(:,3),xh10(:,1),'k-d')
...
figure(9)
plot(uuc(idxc1),yc(idxc1),'r',uum(idxm1),ym(idxm1),'b',uuf(idxf1),yf(idxf1),'g',xh1(:,4),xh1(:,1),'k-d')
...
figure(10)
plot(uuc(idxc4),yc(idxc4),'r',uum(idxm4),ym(idxm4),'b',uuf(idxf4),yf(idxf4),'g',xh4(:,4),xh4(:,1),'k-d')
...
figure(11)
plot(uuc(idxc6),yc(idxc6),'r',uum(idxm6),ym(idxm6),'b',uuf(idxf6),yf(idxf6),'g',xh6(:,4),xh6(:,1),'k-d')
...
figure(12)
plot(uuc(idxc10),yc(idxc10),'r',uum(idxm10),ym(idxm10),'b',uuf(idxf10),yf(idxf10),'g',xh10(:,4),xh10(:,1),'k-d')
...
figure(13)
plot(vvc(idxc1),yc(idxc1),'r',vvm(idxm1),ym(idxm1),'b',vvf(idxf1),yf(idxf1),'g',xh1(:,5),xh1(:,1),'k-d')
...
figure(14)
plot(vvc(idxc4),yc(idxc4),'r',vvm(idxm4),ym(idxm4),'b',vvf(idxf4),yf(idxf4),'g',xh4(:,5),xh4(:,1),'k-d')
...
figure(15)
plot(vvc(idxc6),yc(idxc6),'r',vvm(idxm6),ym(idxm6),'b',vvf(idxf6),yf(idxf6),'g',xh6(:,5),xh6(:,1),'k-d')
...
figure(16)
plot(vvc(idxc10),yc(idxc10),'r',vvm(idxm10),ym(idxm10),'b',vvf(idxf10),yf(idxf10),'g',xh10(:,5),xh10(:,1),'k-d')
...
figure(17)
plot(uvc(idxc1),yc(idxc1),'r',uvm(idxm1),ym(idxm1),'b',uvf(idxf1),yf(idxf1),'g',xh1(:,6),xh1(:,1),'k-d')
...
figure(18)
plot(uvc(idxc4),yc(idxc4),'r',uvm(idxm4),ym(idxm4),'b',uvf(idxf4),yf(idxf4),'g',xh4(:,6),xh4(:,1),'k-d')
...
figure(19)
plot(uvc(idxc6),yc(idxc6),'r',uvm(idxm6),ym(idxm6),'b',uvf(idxf6),yf(idxf6),'g',xh6(:,6),xh6(:,1),'k-d')
...
figure(20)
plot(uvc(idxc10),yc(idxc10),'r',uvm(idxm10),ym(idxm10),'b',uvf(idxf10),yf(idxf10),'g',xh10(:,6),xh10(:,1),'k-d')
...
figure(21)
plot(kc(idxc1),yc(idxc1),'r',km(idxm1),ym(idxm1),'b',kf(idxf1),yf(idxf1),'g')
...
figure(22)
plot(kc(idxc4),yc(idxc4),'r',km(idxm4),ym(idxm4),'b',kf(idxf4),yf(idxf4),'g')
...
figure(23)
plot(kc(idxc6),yc(idxc6),'r',km(idxm6),ym(idxm6),'b',kf(idxf6),yf(idxf6),'g')
...
figure(24)
plot(kc(idxc10),yc(idxc10),'r',km(idxm10),ym(idxm10),'b',kf(idxf10),yf(idxf10),'g')
...
figure(25)
plot(ec(idxc1),yc(idxc1),'r',em(idxm1),ym(idxm1),'b',ef(idxf1),yf(idxf1),'g')
...
figure(26)
plot(ec(idxc4),yc(idxc4),'r',em(idxm4),ym(idxm4),'b',ef(idxf4),yf(idxf4),'g')
...
figure(27)
plot(ec(idxc6),yc(idxc6),'r',em(idxm6),ym(idxm6),'b',ef(idxf6),yf(idxf6),'g')
...
figure(28)
plot(ec(idxc10),yc(idxc10),'r',em(idxm10),ym(idxm10),'b',ef(idxf10),yf(idxf10),'g')
